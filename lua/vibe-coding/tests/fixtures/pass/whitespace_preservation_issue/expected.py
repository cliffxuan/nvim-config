...
"""
    ...
    try:
        ...
        console.print('[dim]type SITE = Literal["cuda", "rocm"][/dim]')
        console.print('[dim]type PLATFORM = Literal["daier", "dusk"][/dim]')
        console.print(
            f"[dim]type MIXTURE with {len(all_mixtures)} mixtures[/dim]"
        )
